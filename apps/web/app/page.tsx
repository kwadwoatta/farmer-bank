...
import { BanksQuery, useBanksQuery } from "@/graphql/_generated_/_gql_";
...
export type Bank = Omit<
  Exclude<BanksQuery, undefined>["banks"][number],
  "displayImageUrl"
> & {
  displayImageUrl: string | StaticImageData;
};
